...
namespace NumbersToWords.Converter
{
    ...
    internal class ArabicConverter : IConverter
    {
        ...
        #endregion Varaibles & Properties
        ...
        public string Convert(Decimal number, CurrencyInfo currency)
        {
            ...
            InitializeClass(number, currency, String.Empty, String.Empty, String.Empty, String.Empty);
        ...
        private string GetDecimalValue(string decimalPart)
        {
            ...
            if (Currency.PartPrecision != decimalPart.Length)
            {
                ...
                result = (Math.Round(System.Convert.ToDecimal(result))).ToString();
            }
            else
                result = decimalPart;
        ...
        private void ExtractIntegerAndDecimalParts()
        {
            ...
            _intergerValue = System.Convert.ToInt32(splits[0]);

            if (splits.Length > 1)
                _decimalValue = System.Convert.ToInt32(GetDecimalValue(splits[1]));
        }
        ...
        #endregion English Number To Word
        ...
        #endregion Arabic Number To Word
    }
}